...
def load_models():
	# unreal.load_asset('/Game/Models/NewModels/Female.Female')
	# unreal.load_asset('/Game/Models/NewModels/Female_Skeleton.Female_Skeleton')
	unreal.load_asset('/Game/Models/NewModels/Male.Female')
	unreal.load_asset('/Game/Models/NewModels/Male_Skeleton.Female_Skeleton')
